...
public class SeatReservationGoBack extends JFrame{
	...
	public SeatReservationGoBack(int flightNumber,int returnFlightNumber) {
                ...
                studentSpinner.setEnabled(false);
       	        ...
       	        if(economyRadio.isSelected()==true) {
           	        ...
           	        for (int i = 0; i < adultCount; i++) {
           	        	String query = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('adult', " + adultPrice2 + ", " + flight_id + ");";
           	            database.islemler(query);
           	            String query2 = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('adult', " + adultPrice2 + ", " + returnFlightNumber + ");";
           	        ...
           	        for (int i = 0; i < childCount; i++) {
           	        	String query = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('child', " + childPrice2 + ", " + flight_id + ");";
           	            database.islemler(query);
           	            String query2 = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('child', " + childPrice2 + ", " + returnFlightNumber + ");";
        	            database.islemler(query2);
           	        }

           	        // Baby yolcuları eklemek için döngü
           	        for (int i = 0; i < babyCount; i++) {
           	        	String query = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('baby', " + babyPrice2 + ", " + flight_id + ");";
           	            database.islemler(query);
           	            String query2 = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('baby', " + babyPrice2 + ", " + returnFlightNumber + ");";
        	            database.islemler(query2);
           	        }

           	        // Student yolcuları eklemek için döngü
           	        for (int i = 0; i < studentCount; i++) {
           	        	String query = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('student', " + studentPrice2 + ", " + flight_id + ");";
           	            database.islemler(query);
           	            String query2 = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('student', " + studentPrice2 + ", " + returnFlightNumber + ");";
        	            database.islemler(query2);
           	        }
        	        ...
        	        priceCount.setText(Integer.toString(fiyat));
           	        ...
           	        // Adult yolcuları eklemek için döngü
           	        for (int i = 0; i < adultCount; i++) {
           	        	String query = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('adult', " + adultPrice + ", " + flight_id + ");";
           	            database.islemler(query);
           	            String query2 = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('adult', " + adultPrice + ", " + returnFlightNumber + ");";
        	            database.islemler(query2);
           	        ...
           	        // Child yolcuları eklemek için döngü
           	        for (int i = 0; i < childCount; i++) {
           	        	String query = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('child', " + childPrice + ", " + flight_id + ");";
           	            database.islemler(query);
           	            String query2 = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('child', " + childPrice + ", " + returnFlightNumber + ");";
        	            database.islemler(query2);
           	        }

           	        // Baby yolcuları eklemek için döngü
           	        for (int i = 0; i < babyCount; i++) {
           	        	String query = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('baby', " + babyPrice + ", " + flight_id + ");";
           	            database.islemler(query);
           	            String query2 = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('baby', " + babyPrice + ", " + returnFlightNumber + ");";
        	            database.islemler(query2);
           	        }

           	        // Student yolcuları eklemek için döngü
           	        for (int i = 0; i < studentCount; i++) {
           	        	String query = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('student', " + studentPrice + ", " + flight_id + ");";
           	            database.islemler(query);
           	            String query2 = "INSERT INTO nationalPassenger(passenger_type, passenger_price, flight_id) VALUES ('student', " + studentPrice + ", " + returnFlightNumber + ");";
        	            database.islemler(query2);
           	        }
    ...
    private void InsertSeat(int seatNumber, int passengerNo, boolean isOccupied, String seatClass, int flight_id) {
        String query = "INSERT INTO nationalseats (seat_number, passenger_no, is_occupied, class, flight_id) " +
    ...
    private int[] GetPassengerNumber(int totalPassenger) {
        ...
        String query = "(SELECT passenger_no FROM nationalPassenger ORDER BY passenger_no DESC LIMIT " + totalPassenger + ")";
