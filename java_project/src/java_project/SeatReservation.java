...
public class SeatReservation extends JFrame{
	...
	private int k = 0;
	 ...
	 private JLabel seatLabel = new JLabel("Koltuk Seçimi");
	//koltuklar için
	...
	public SeatReservation(int flightNumber) {
       	    ...
       	    public void actionPerformed(ActionEvent e) {
                ...
                studentSpinner.setEnabled(false);
       	        ...
       	        if(economyRadio.isSelected()==true) {
           	        ...
           	        fiyat = adultCount*adultPrice2+childCount*childPrice2+babyCount*babyPrice2+studentCount*studentPrice2;
